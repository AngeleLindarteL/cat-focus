...
export const translationCatalog = {
  en: {
    ...
    stepTwoDescription: "Pick a blocking method for onboarding. You can continue once you save at least one schedule or usage block.",
  ...
  es: {
    ...
    stepTwoDescription: "Selecciona un método de bloqueo para el onboarding. Puedes continuar cuando guardes al menos un bloqueo por horario o por tiempo de uso.",
