...
export const translationCatalog = {
  en: {
    ...
    toastCatSaved: "Cat profile saved!",
    toastPreferencesSaved: "Preferences saved!",
    toastScheduleCreated: "Schedule block created!",
    toastScheduleUpdated: "Schedule block updated!",
    toastScheduleDeleted: "Schedule block deleted.",
    toastUsageCreated: "Usage limit created!",
    toastUsageUpdated: "Usage limit updated!",
    toastUsageDeleted: "Usage limit deleted.",
    toastSaveError: "Something went wrong. Please try again.",
    weekdayMonday: "Mon",
    weekdayTuesday: "Tue",
  ...
  es: {
    ...
    toastCatSaved: "¡Perfil del gato guardado!",
    toastPreferencesSaved: "¡Preferencias guardadas!",
    toastScheduleCreated: "¡Bloque de horario creado!",
    toastScheduleUpdated: "¡Bloque de horario actualizado!",
    toastScheduleDeleted: "Bloque de horario eliminado.",
    toastUsageCreated: "¡Límite de uso creado!",
    toastUsageUpdated: "¡Límite de uso actualizado!",
    toastUsageDeleted: "Límite de uso eliminado.",
    toastSaveError: "Algo salió mal. Por favor, inténtalo de nuevo.",
    weekdayMonday: "Lun",
    weekdayTuesday: "Mar",
